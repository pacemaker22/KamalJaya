				...
				<Row className="flex-wrap">
					<Col className="d-flex flex-column justify-content-center">
						<Row className="upper-footer">
							<Col className="topic-footer" id="discover">
								...
								<ul className="footer-lists">
									...
									<li>
										<Link href="/produk/alatTulis">
											<a>Alat Tulis</a>
										</Link>
									</li>
									<li>
										<Link href="/produk/alatMusik">
											<a>Alat Musik</a>
										</Link>
									</li>
									<li>
						...
						<Row className="lower-footer">
							<Col>
								Copyright Universitas Esa Unggul &copy; {currentYear}
								<span className="ms-2">
									<Link href="https://kamaljaya.xyz" passHref>
										<a target="_blank">Artik Nurochman</a>
									</Link>
								</span>
							</Col>
						</Row>
